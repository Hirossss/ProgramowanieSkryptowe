...
def test_for_map_2_2(
    ...
    assert rectangular_map_2_2.place(animal1) is None # wczesniej False
    assert rectangular_map_2_2.place(animal2) is None # wczesniej False
    assert rectangular_map_2_2.place(animal3) is True 
    assert rectangular_map_2_2.place(animal4) is None # wczesniej False
