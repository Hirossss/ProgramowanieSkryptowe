...
TypeError: Can't instantiate abstract class IMoveValidator with abstract method canMoveTo
>>> obj2 = IWorldMap()
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
TypeError: Can't instantiate abstract class IWorldMap with abstract methods isOccupied, move, objectAt, place
'''